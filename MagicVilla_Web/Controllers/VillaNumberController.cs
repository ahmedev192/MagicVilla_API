...
namespace MagicVilla_Web.Controllers
{
    public class VillaNumberController : Controller
    {
        ...
        public async Task<IActionResult> Update(int villaNumber)
        {
            ...
            {
                villaNumberVM.VillaList = JsonConvert.DeserializeObject<List<VillaDTO>>(Convert.ToString(res.Result)).Select(i => new SelectListItem
                {
                    Text = i.Name,
                    Value = i.Id.ToString()
                });
        ...
        public async Task<IActionResult> Delete(VillaNumberDeleteVM model)
        {
            ...
            var response = await _villaNumberService.RemoveAsync<APIResponse>(model.VillaNumber.VillaNumber, HttpContext.Session.GetString(SD.SessionToken));
            if (response != null && response.IsSuccess)
            {
